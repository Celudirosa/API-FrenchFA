 ...
 * @WebMvcTest.
 * 
 * Con esta anotacion seria suficiente, si no tuviesemos configurado Spring
 * Security,
 * porque permitiria cargar el controlador especifico y sus dependencias sin
 * tener que
 * cargar todo el contexto de la aplicacion, y aqui es donde tendriamos un
 * problema con
 * Spring Security, pues si necesitamos levantar todo el contexto de la
 * aplicacion.
 *
 * Tambien permite autoconfigurar MockMvc para realizar test a los
 * controladores, es
...
public class MainControllerTests {
        ...
        @Test
        @WithMockUser(username = "noadmin@blue.com", authorities = { "TRAINER" })
        // No debería asignarle una contraseña????????? como lo hago
