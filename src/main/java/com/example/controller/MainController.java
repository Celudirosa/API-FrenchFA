...
public class MainController {
    ...
    public ResponseEntity<Map<String, Object>> updateAttendee(@Valid @RequestBody Attendee attendee,
        ...
        try {
            ...
            attendee = attendeeService.findById(idAttendee);
            Level lastLevel = attendeeService.getLastLevelForAttendee(attendee);

            // Actualizar el campo lastLevel del attendee
            attendeeService.updateLastLevelForAttendee(attendee, lastLevel);
            String succesMessage = "The attendee has been saved succesfully";
            responseAsMap.put("Succes Message", succesMessage);
